...
def test_exchange_repo_create_and_find(exchange_repo, ad_repo, user):
    # Create two ads for the exchange
    ad1 = ad_domain.Ad(
        user_id=user.id,
...
def test_exchange_repo_find_user_proposals_empty(exchange_repo):
    # Test with user who has no proposals
